              ...
              dispatch(
                setFormData({
                  ...
                  deliveryAddress: {
                    ...
                    building:
                      data.personal_data?.pickup_address?.building ?? "",
                    city: data.personal_data?.pickup_address?.city ?? "",
                    commentary:
                      data.personal_data?.pickup_address?.comment ?? "",
                    entryway:
                      data.personal_data?.pickup_address?.entrance ?? "",
