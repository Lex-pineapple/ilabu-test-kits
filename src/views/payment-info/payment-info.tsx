...
const ORDER_STEPS = [
  {
    title:
      "Отсканировать QR-код набора на упаковке либо ввести данные вручную в поле ввода.",
  },
  {
    title:
      'Выбрать и добавить в корзину необходимые исследования. Нажать кнопку "Продолжить".',
  },
  {
    title:
      'Заполнить детали заказа: Имя, Фамилию, Отчество (при наличии), пол, дату рождения, email, и способ доставки материала. Нажать кнопку "Продолжить".',
  },
  {
    title:
      "Подтвердить email при помощи четырехзначного кода, отправленного на электронную почту.",
  },
  { title: 'Проверить введенные детали заказа, нажать кнопку "Оплатить".' },
  {
    title:
      "Перейти к экрану оплаты сервиса Web Pay. Ввести необходимые данные для оплаты заказа.",
  },
  {
    title:
      "Перейти к сбору образца: осуществить самостоятельное взятия биоматериала на дому следуя инструкции, описанной на сайте.",
  },
  {
    title:
      'Отсканировать штрихкоды пробирок либо введите данные вручную в соответствующие поля на странице сайта.  Нажать кнопку "Продолжить".',
  },
  {
    title:
      "Храните и доставьте образец в лабораторию, следуя указаниям на сайте.",
  },
];
    ...
    <Stack gap={8}>
      ...
      <Container p={0}>
        ...
        <Text as="span" fontWeight={"semibold"}>
          «Расчёт» (АИС ЕРИП) выберите услугу «г.Минск- ООО «ПрофЛабДиагностика»
          - kits.mylab.by» и введите номер счёта 10000018.
        </Text>
        <Text pt={3}>
